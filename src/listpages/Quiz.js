                ...
                <OverlayTrigger trigger="click" placement="right" overlay={popover}
                 ...
                 placement={'bottom'}>
                  ...
                  <div className="addthis_inline_share_toolbox"
                   style={{marginTop: 24}}
                  data-url={`${window.location.origin}/quiz/${quizKey.slice(1)}`} data-title={`${this.props.main.name} wants to know whether you are his/her Best friend or not? Play His Friendship Quiz Now!`}
                  >
                  </div>
